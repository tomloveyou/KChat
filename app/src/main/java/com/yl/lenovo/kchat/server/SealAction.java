package com.yl.lenovo.kchat.server;
...
import com.yl.lenovo.kchat.server.request.AddGroupMemberRequest;
import com.yl.lenovo.kchat.server.request.AddToBlackListRequest;
import com.yl.lenovo.kchat.server.request.AgreeFriendsRequest;
import com.yl.lenovo.kchat.server.request.ChangePasswordRequest;
import com.yl.lenovo.kchat.server.request.CheckPhoneRequest;
import com.yl.lenovo.kchat.server.request.CreateGroupRequest;
import com.yl.lenovo.kchat.server.request.DeleteFriendRequest;
import com.yl.lenovo.kchat.server.request.DeleteGroupMemberRequest;
import com.yl.lenovo.kchat.server.request.DismissGroupRequest;
import com.yl.lenovo.kchat.server.request.FriendInvitationRequest;
import com.yl.lenovo.kchat.server.request.JoinGroupRequest;
import com.yl.lenovo.kchat.server.request.LoginRequest;
import com.yl.lenovo.kchat.server.request.QuitGroupRequest;
import com.yl.lenovo.kchat.server.request.RegisterNocodeRequest;
import com.yl.lenovo.kchat.server.request.RegisterRequest;
import com.yl.lenovo.kchat.server.request.RemoveFromBlacklistRequest;
import com.yl.lenovo.kchat.server.request.RestPasswordRequest;
import com.yl.lenovo.kchat.server.request.SendCodeRequest;
import com.yl.lenovo.kchat.server.request.SetFriendDisplayNameRequest;
import com.yl.lenovo.kchat.server.request.SetGroupDisplayNameRequest;
import com.yl.lenovo.kchat.server.request.SetGroupNameRequest;
import com.yl.lenovo.kchat.server.request.SetGroupPortraitRequest;
import com.yl.lenovo.kchat.server.request.SetNameRequest;
import com.yl.lenovo.kchat.server.request.SetPortraitRequest;
import com.yl.lenovo.kchat.server.request.VerifyCodeRequest;
import com.yl.lenovo.kchat.server.response.AddGroupMemberResponse;
import com.yl.lenovo.kchat.server.response.AddToBlackListResponse;
import com.yl.lenovo.kchat.server.response.AgreeFriendsResponse;
import com.yl.lenovo.kchat.server.response.ChangePasswordResponse;
import com.yl.lenovo.kchat.server.response.CheckPhoneResponse;
import com.yl.lenovo.kchat.server.response.CreateGroupResponse;
import com.yl.lenovo.kchat.server.response.DefaultConversationResponse;
import com.yl.lenovo.kchat.server.response.DeleteFriendResponse;
import com.yl.lenovo.kchat.server.response.DeleteGroupMemberResponse;
import com.yl.lenovo.kchat.server.response.DismissGroupResponse;
import com.yl.lenovo.kchat.server.response.FriendInvitationResponse;
import com.yl.lenovo.kchat.server.response.GetBlackListResponse;
import com.yl.lenovo.kchat.server.response.GetFriendInfoByIDResponse;
import com.yl.lenovo.kchat.server.response.GetGroupInfoResponse;
import com.yl.lenovo.kchat.server.response.GetGroupMemberResponse;
import com.yl.lenovo.kchat.server.response.GetGroupResponse;
import com.yl.lenovo.kchat.server.response.GetTokenResponse;
import com.yl.lenovo.kchat.server.response.GetUserInfoByIdResponse;
import com.yl.lenovo.kchat.server.response.GetUserInfoByPhoneResponse;
import com.yl.lenovo.kchat.server.response.GetUserInfosResponse;
import com.yl.lenovo.kchat.server.response.JoinGroupResponse;
import com.yl.lenovo.kchat.server.response.LoginResponse;
import com.yl.lenovo.kchat.server.response.QiNiuTokenResponse;
import com.yl.lenovo.kchat.server.response.QuitGroupResponse;
import com.yl.lenovo.kchat.server.response.RegisterResponse;
import com.yl.lenovo.kchat.server.response.RemoveFromBlackListResponse;
import com.yl.lenovo.kchat.server.response.RestPasswordResponse;
import com.yl.lenovo.kchat.server.response.SendCodeResponse;
import com.yl.lenovo.kchat.server.response.SetFriendDisplayNameResponse;
import com.yl.lenovo.kchat.server.response.SetGroupDisplayNameResponse;
import com.yl.lenovo.kchat.server.response.SetGroupNameResponse;
import com.yl.lenovo.kchat.server.response.SetGroupPortraitResponse;
import com.yl.lenovo.kchat.server.response.SetNameResponse;
import com.yl.lenovo.kchat.server.response.SetPortraitResponse;
import com.yl.lenovo.kchat.server.response.SyncTotalDataResponse;
import com.yl.lenovo.kchat.server.response.UserRelationshipResponse;
import com.yl.lenovo.kchat.server.response.VerifyCodeResponse;
import com.yl.lenovo.kchat.server.response.VersionResponse;
import com.yl.lenovo.kchat.server.utils.NLog;
import com.yl.lenovo.kchat.server.utils.json.JsonMananger;
...
public class SealAction extends BaseAction {
    ...
    * */
     ...
     * @throws HttpException
     */
    public RegisterResponse registerNOCode(String nickname, String password) throws HttpException {
        String url = getURL("user/register");
        StringEntity entity = null;
        try {
            entity = new StringEntity(JsonMananger.beanToJson(new RegisterNocodeRequest(nickname, password)), ENCODING);
        } catch (UnsupportedEncodingException e) {
            e.printStackTrace();
        }
