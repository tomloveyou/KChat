package com.mfc.appframe.utils.datetimpick;
...
import com.mfc.appframe.utils.datetimpick.Utils.DateUtil;
import com.mfc.appframe.utils.datetimpick.Utils.ScreenUtil;
import com.mfc.appframe.utils.datetimpick.Utils.TextUtil;
import com.mfc.appframe.utils.datetimpick.view.PickerView;
 ...
 */
public class PersonTimeSelector {
    ...
    public PersonTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String show) {
        ...
        showCalendar.setTime(DateUtil.parse(show, FORMAT_STR));
        initDialog();
        initView();
    }


    public PersonTimeSelector(Context context, ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime, String show) {
        this(context, resultHandler, startDate, endDate, show);
    ...
    private void initView() {
        year_pv = (PickerView) seletorDialog.findViewById(R.id.person_year_pv);
        month_pv = (PickerView) seletorDialog.findViewById(R.id.person_month_pv);
        day_pv = (PickerView) seletorDialog.findViewById(R.id.person_day_pv);
        hour_pv = (PickerView) seletorDialog.findViewById(R.id.person_hour_pv);
        minute_pv = (PickerView) seletorDialog.findViewById(R.id.person_minute_pv);
        tv_cancle = (TextView) seletorDialog.findViewById(R.id.date_tv_cancle);
        tv_select = (TextView) seletorDialog.findViewById(R.id.date_tv_select);
        tv_title = (TextView) seletorDialog.findViewById(R.id.date_tv_title);
        hour_text = (TextView) seletorDialog.findViewById(R.id.person_hour_text);
        minute_text = (TextView) seletorDialog.findViewById(R.id.person_minute_text);
        ...
        tv_select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                handler.handle((DateUtil.format(selectedCalender.getTime(), FORMAT_STR)).substring(0, 10));
                seletorDialog.dismiss();
            }
        });
    ...
    private void loadComponent() {
        ...
        year_pv.setSelected(year.get(year.size() - 1));
        month_pv.setSelected(startCalendar.get(Calendar.MONTH));
        day_pv.setSelected(startCalendar.get(Calendar.DAY_OF_MONTH) - 1);
