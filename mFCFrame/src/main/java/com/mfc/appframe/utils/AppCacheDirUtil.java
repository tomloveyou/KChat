...
public class AppCacheDirUtil {
	...
	public static String getDownloadPath() {
		File file = new File(AppCacheDirUtil.getSDDir()+File.separator+MainApplication.getPropertyValue("projectName")+"/download/");
		if (!file.exists()) {
			file.mkdirs();
		}
	...
	public static String getCrashLogPath() {
		File file = new File(AppCacheDirUtil.getSDDir()+File.separator+MainApplication.getPropertyValue("projectName")+"/crash/");
		if (!file.exists()) {
			file.mkdirs();
		}
		return file.getAbsolutePath();
