...
import com.mfc.appframe.utils.datetimpick.Utils.DateUtils;
...
public class TimeSelector {
    ...
    private void initView() {
        ...
        year_tip= (TextView) seletorDialog.findViewById(R.id.year_pv_tip);
    ...
    private void initParameter() {
        ...
        startHour = startCalendar.get(Calendar.HOUR_OF_DAY)-8;
        ...
        selectedCalender.setTime((DateUtil.parse(startYear+2+"-"+startMonth+"-"+startDay+" "+(startHour)+":"+startMininute, FORMAT_STR)));
    }
    ...
    private void loadComponent() {
        ...
        year_pv.setSelected(Calendar.getInstance().get(Calendar.YEAR));
        month_pv.setSelected(fomatTimeUnit(Calendar.getInstance().get(Calendar.MONTH)+1));
        day_pv.setSelected(fomatTimeUnit(Calendar.getInstance().get(Calendar.DAY_OF_MONTH)));
        hour_pv.setSelected(fomatTimeUnit(Calendar.getInstance().get(Calendar.HOUR_OF_DAY)-8));
        minute_pv.setSelected(fomatTimeUnit(Calendar.getInstance().get(Calendar.MINUTE)));
        excuteScroll();
    }

    private void excuteScroll() {
    /*    year_pv.setVisibility(View.GONE);
        year_tip.setVisibility(View.GONE);*/
