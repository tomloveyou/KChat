...
import com.mfc.appframe.components.ProgressSpinnerDialog;
...
public class DialogUtils {
	...
	public static synchronized void showProgressDialog(Context context, String text, DialogDismissListener dismissListener) {
		if (context == null) {
			dialog = null;
			return;
	...
	public static synchronized void showProgressDialog(Context context, String text, int countDownTime, DialogDismissListener dismissListener) {
		if (context == null) {
			dialog = null;
